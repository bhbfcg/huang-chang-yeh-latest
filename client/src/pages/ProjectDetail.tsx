...
const detailData: Record<string, { intro: string; body: string; gallery: string[] }> = {
  ...
  "light-church-tudigong-temple": { intro: "Light turns a familiar ritual into a new threshold.", body: "以光作為進入信仰空間的引導，將傳統土地公廟的屋頂、牌樓與祭祀軸線，重新組織成具有弧形量體與中央入口的建築概念。方案不抹去熟悉的宗教記憶，而是透過尺度、曲面與明暗，把傳統儀式轉化為更開放的公共性場景。", gallery: ["/assets/picture1-temple-02.webp", "/assets/picture1-temple-03.webp"] },
  ...
  "rhino-form-study": { intro: "Studying how surfaces become structure.", body: "以流線、孔洞、骨架與表皮作為形式研究，觀察一個物件如何在曲面、結構與陰影之間找到平衡。這些練習不直接追求完成品，而是保留建模過程中的推演性，作為空間與產品尺度設計的形式基礎。", gallery: ["/assets/picture1-rhino-02.webp", "/assets/picture1-rhino-03.webp", "/assets/picture1-rhino-04.webp", "/assets/picture1-rhino-05.webp", "/assets/picture1-rhino-06.webp"] },
  "yushan-community-3d": { intro: "Turning a residential brief into a lived-in image.", body: "以客廳與餐廳情境呈現住宅配置的完整性，練習將平面需求轉化為光線、家具、材質與生活物件共同構成的畫面。這組作品反映實務協作中的視覺表達能力，也說明 3D 圖像如何幫助設計溝通。", gallery: ["/assets/picture1-yushan-02.webp"] },
};
